...
REM  no effect if you are in "-grasp" mode. But I am leaving this here for future 
REM  developments where we might want to output some captured Grasp packets as well.
set PACKET_SOURCE=".\\GraspPacketsForSimulator.gpk"
...
REM ************************************************************************************
REM Work in progress. The GraspMMI is not here yet.
REM Just launch the support processes above, then quit.
REM 
goto :eof
REM ************************************************************************************
